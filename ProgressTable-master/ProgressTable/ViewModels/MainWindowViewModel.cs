...
namespace ProgressTable.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public MainWindowViewModel()
        {
            ...
            {
                new Student{Name="Казьмин Сергей Вячеславович", Visual=2, Architecture=2, Networks=2, Calculate_Math=1, PI=1, Math=1, Electric=2},
                new Student{Name="Ритцель Герман Федорович", Visual=1, Architecture=1, Networks=1, Calculate_Math=0, PI=1, Math=2, Electric=2},
                new Student{Name="Немцев Дмитрий Андреевич", Visual=0, Architecture=1, Networks=2, Calculate_Math=1, PI=1, Math=1, Electric=2},
            };
            CheckAverage(students);
